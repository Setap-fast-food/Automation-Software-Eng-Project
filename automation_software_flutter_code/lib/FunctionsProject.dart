...
abstract class OrderManager {
  ...
  Future<void> editOrder(String orderId, String customerName, List<String> items);
}
...
class OrderManagerImpl implements OrderManager {
  ...
  Future<Order> getOrder(String orderId) async {
    ...
    if (results.isNotEmpty) {
      ...
      return Order(order[0].toString(), order[1].toString(), (order[2] as List<dynamic>).map((item) => item.toString()).toList());
    } else {
      return null;
    }
  }
  ...
  @override
  Future<void> editOrder(String orderId, String customerName, List<String> items) async {
...
//  )
  ...
  final connection = PostgreSQLConnection('localhost', 5432, 'your_database_name',
